...
from .views import CustomUserRetrieveUpdateDestroyView, EmailTokenObtainPairView, CustomUserCreateView, UserProfile, forget_password, reset_password, verify_email
